---
title: Icon Systems
description: **Referenced Files in This Document** `packages/morphicons-svelte/README.md` `packages/morphicons-svelte/src/lib/MorphIcon.svelte` `packages/morphicons-svelte/src/lib/index.ts` `packages/morphicons-sv…
type: item
---
<cite>
**Referenced Files in This Document**
- `packages/morphicons-svelte/README.md`
- `packages/morphicons-svelte/src/lib/MorphIcon.svelte`
- `packages/morphicons-svelte/src/lib/index.ts`
- `packages/morphicons-svelte/package.json`
- `packages/svelte-animated-icon/README.md`
- `packages/svelte-animated-icon/src/lib/index.ts`
- `packages/svelte-animated-icon/package.json`
- `packages/svelte-icons/README.md`
- `packages/svelte-icons/src/lib/Icon.svelte`
- `packages/svelte-icons/src/lib/index.ts`
- `packages/svelte-icons/src/lib/types.ts`
- `packages/svelte-icons/package.json`
</cite>
...
**Diagram sources**
- `packages/morphicons-svelte/src/lib/index.ts#L1-L18`
- `packages/morphicons-svelte/package.json#L1-L59`
- `packages/svelte-animated-icon/src/lib/index.ts#L1-L6`
- `packages/svelte-animated-icon/package.json#L1-L90`
- `packages/svelte-icons/src/lib/index.ts#L1-L3`
- `packages/svelte-icons/src/lib/types.ts#L1-L9`
- `packages/svelte-icons/package.json#L1-L85`

**Section sources**
- `packages/morphicons-svelte/README.md#L1-L69`
- `packages/svelte-animated-icon/README.md#L1-L26`
- `packages/svelte-icons/README.md#L1-L118`
...
**Section sources**
- `packages/morphicons-svelte/src/lib/MorphIcon.svelte#L1-L232`
- `packages/morphicons-svelte/src/lib/index.ts#L1-L18`
- `packages/svelte-animated-icon/src/lib/index.ts#L1-L6`
- `packages/svelte-icons/src/lib/Icon.svelte#L1-L36`
- `packages/svelte-icons/src/lib/types.ts#L1-L9`

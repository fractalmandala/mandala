...
description: **Referenced Files in This Document** `fractal-agentic/bin/cli.js` `fractal-agentic/package.json` `fractal-agentic/docs/02-install.md` `fractal-agentic/commands/auto-update.md` `fractal-agentic/comman…
type: item
---
<cite>
...
**Section sources**
- `fractal-agentic/commands/project-init.md#L1-L87`

---
title: Boss Activation Commands
description: **Referenced Files in This Document** `commands/activate-boss-agent.md` `commands/activate-boss-code.md` `commands/activate-boss-creator.md` `commands/activate-boss-design.md` `commands/activate-boss-…
type: item
---
<cite>
**Referenced Files in This Document**
- `commands/activate-boss-agent.md`
- `commands/activate-boss-code.md`
- `commands/activate-boss-creator.md`
- `commands/activate-boss-design.md`
- `commands/activate-boss-meta.md`
- `commands/activate-boss-svelte.md`
- `commands/activate-boss-workflow.md`

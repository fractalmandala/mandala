---
title: Build Configuration & Tooling
description: **Referenced Files in This Document** `packages/fractal-svelte/package.json` `packages/fractal-svelte/vite.config.ts` `packages/fractal-svelte/tsconfig.json` `packages/fractal-svelte/svelte.config.js`…
type: item
---
<cite>
...
- `packages/fractals-styler/tsconfig.json`
...
- `packages/fractal-agentic/scripts/install-agents.sh`
- `packages/fractal-agentic/scripts/check-armory.sh`
- `packages/fractal-agentic/package.json`
- `packages/fractal-svelte/scripts/generate-catalog.ts`
- `packages/fractal-svelte/scripts/check-catalog.ts`
</cite>

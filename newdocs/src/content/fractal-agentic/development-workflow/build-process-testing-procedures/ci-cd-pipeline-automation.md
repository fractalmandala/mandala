...
description: **Referenced Files in This Document** `fractal-svelte/.github/workflows/ci.yml` `fractal-svelte/package.json` `fractal-agentic/workflows/monorepo-release.workflow.md` `fractal-agentic/workflows/review…
type: item
---
<cite>

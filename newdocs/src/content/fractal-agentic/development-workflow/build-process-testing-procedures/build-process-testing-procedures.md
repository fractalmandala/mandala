---
title: Build Process & Testing Procedures
...
- `packages/fractal-svelte/svelte.config.js`
- `packages/fractal-svelte/tsconfig.json`
- `packages/fractal-svelte/.github/workflows/ci.yml`
...
- `packages/morphicons-svelte/vite.config.ts`
- `packages/morphicons-svelte/tests/MorphIcon.ssr.test.ts`
- `packages/morphicons-svelte/tests/MorphIcon.browser.test.ts`
- `packages/svelte-animated-icon/vite.config.ts`
- `packages/svelte-icons/package.json`
- `packages/svelte-icons/vite.config.ts`
</cite>
...
- `packages/fractal-svelte/svelte.config.js#L1-L18`
- `packages/fractal-svelte/tsconfig.json#L1-L16`
- `packages/fractal-svelte/.github/workflows/ci.yml#L1-L37`
- `packages/morphicons-svelte/package.json#L27-L33`
- `packages/morphicons-svelte/vite.config.ts#L1-L12`
- `packages/svelte-animated-icon/vite.config.ts#L1-L22`
- `packages/svelte-icons/package.json#L5-L16`
- `packages/svelte-icons/vite.config.ts#L1-L20`
...
**Diagram sources**
- `packages/morphicons-svelte/tests/MorphIcon.ssr.test.ts#L1-L98`
- `packages/morphicons-svelte/vite.config.ts#L1-L12`

**Section sources**
- `packages/morphicons-svelte/tests/MorphIcon.ssr.test.ts#L1-L98`
- `packages/morphicons-svelte/tests/MorphIcon.browser.test.ts#L1-L114`
- `packages/morphicons-svelte/vite.config.ts#L1-L12`
...
- `packages/svelte-icons/vite.config.ts#L1-L20`
- `packages/fractal-svelte/tsconfig.json#L1-L16`
- `packages/fractal-svelte/package.json#L219-L243`

...
description: **Referenced Files in This Document** `fractal-agentic/skills/INDEX.md` `fractal-agentic/docs/orchestration/runtime.md` `fractal-agentic/docs/orchestration/capability-lanes.md` `fractal-agentic/skills…
type: item
---
<cite>
...
- `fractal-agentic/skills/context-restore/SKILL.md`
</cite>

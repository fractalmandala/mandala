---
title: Testing & Debugging Skills
...
- `fractal-agentic/skills/skill-comply/pyproject.toml`
- `fractal-agentic/skills/skill-comply/fixtures/tdd_spec.yaml`
- `fractal-agentic/skills/skill-comply/tests/test_grader.py`
- `fractal-agentic/skills/skill-comply/tests/test_runner.py`
- `fractal-agentic/skills/skill-stocktake/SKILL.md`
- `fractal-agentic/skills/e2e-testing/SKILL.md`

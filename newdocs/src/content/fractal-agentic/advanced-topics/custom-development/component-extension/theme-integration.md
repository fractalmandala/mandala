...
- `packages/fractals-styler/GUIDE.md`
...
- `packages/fractalsvelte/src/lib/themes.ts`
- `packages/fractalsvelte/src/lib/themes.json`
</cite>
...
- `packages/fractalsvelte/src/lib/themes.ts#L1-L59`
- `packages/fractalsvelte/src/lib/themes.json#L1-L348`

**Section sources**
- `packages/fractals-styler/README.md#L1-L124`
- `packages/fractals-styler/GUIDE.md#L1-L243`
...
- JIT scanning and CSS generation: `packages/fractals-styler/src/index.ts#L1-L76`, `packages/fractals-styler/src/generate.ts#L1-L62`
- Static registry and breakpoint mapping: `packages/fractals-styler/src/registry.ts#L1-L94`
- Token defaults and typography: `packages/fractals-styler/templates/_tokens.sass#L1-L24`, `packages/fractals-styler/templates/_typography.sass#L1-L59`
- Responsive mixins: `packages/fractals-styler/templates/_mixins.sass#L1-L25`
- Theme types and conversion helper: `packages/fractalsvelte/src/lib/themes.ts#L1-L59`, `packages/fractalsvelte/src/lib/themes.json#L1-L348`
...
**Section sources**
- `packages/fractals-styler/GUIDE.md#L105-L160`
...
- `packages/fractals-styler/templates/_tokens.sass#L1-L24`
- `packages/fractals-styler/templates/_typography.sass#L1-L59`
- `packages/fractals-styler/README.md#L111-L124`
...
**Section sources**
- `packages/fractals-styler/templates/_mixins.sass#L1-L25`
- `packages/fractals-styler/GUIDE.md#L215-L226`
...
**Section sources**
- `packages/fractals-styler/GUIDE.md#L230-L243`
- `packages/fractals-styler/README.md#L1-L124`

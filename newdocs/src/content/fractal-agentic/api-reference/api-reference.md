---
title: API Reference
description: **Referenced Files in This Document** `fractal-agentic/package.json` `fractal-agentic/bin/cli.js` `fractal-agentic/plugin.json` `fractal-agentic/.claude-plugin/plugin.json` `fractal-agentic/commands/I…
type: item
---
<cite>
...
- `fractal-agentic/plugin.json#L1-L31`
- `fractal-agentic/.claude-plugin/plugin.json#L1-L20`
- `fractal-agentic/docs/01-getting-started.md#L1-L99`
...
- `fractal-agentic/hooks/scripts/session-start.js#L47-L64`
- `fractal-agentic/hooks/scripts/pre-bash-safety.js#L26-L41`

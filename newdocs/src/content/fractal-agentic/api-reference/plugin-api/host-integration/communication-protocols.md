...
description: **Referenced Files in This Document** `fractal-agentic/bin/cli.js` `fractal-agentic/.fractal-agentic/hooks.claude.json` `fractal-agentic/hooks/README.md` `fractal-agentic/hooks/scripts/lib.js` `fracta…
type: item
---
<cite>

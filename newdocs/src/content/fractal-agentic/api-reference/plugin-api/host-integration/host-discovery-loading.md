...
- `packages/fractal-agentic/package.json`
- `packages/fractal-agentic/bin/cli.js`
- `packages/fractal-agentic/.claude-plugin/marketplace.json`
- `packages/fractal-agentic/.claude-plugin/plugin.json`
- `packages/fractal-agentic/.claude-plugin/PLUGIN_SCHEMA_NOTES.md`
- `packages/fractal-agentic/.codex-plugin/plugin.json`
- `packages/fractal-agentic/scripts/resolve-plugin-root.sh`
- `packages/fractal-agentic/scripts/check-progressive-discovery.sh`
- `packages/fractal-agentic/scripts/verify.sh`
- `packages/fractal-agentic/docs/02-install.md`
- `packages/fractal-agentic/docs/troubleshooting.md`
- `packages/fractal-agentic/skills/boss-orchestration/references/capability-mode.md`

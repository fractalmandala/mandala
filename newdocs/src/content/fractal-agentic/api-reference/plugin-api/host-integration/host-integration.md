...
description: **Referenced Files in This Document** `fractal-agentic/bin/cli.js` `fractal-agentic/package.json` `fractal-agentic/plugin.json` `fractal-agentic/.claude-plugin/plugin.json` `fractal-agentic/.codex-plu…
type: item
---
<cite>
...
- `fractal-agentic/hooks/scripts/lib.js#L110-L136`

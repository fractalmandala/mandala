---
title: Listing Requirements & Review
description: **Referenced Files in This Document** `fractal-agentic/.claude-plugin/marketplace.json` `fractal-agentic/.claude-plugin/plugin.json` `fractal-agentic/.claude-plugin/PLUGIN_SCHEMA_NOTES.md` `fractal-ag…
type: item
---
<cite>
...
Key files:
- Claude Code marketplace catalog: `fractal-agentic/.claude-plugin/marketplace.json`
- Claude Code plugin identity: `fractal-agentic/.claude-plugin/plugin.json`
- Generic/Antigravity plugin manifest: `fractal-agentic/plugin.json`
- Codex plugin identity: `fractal-agentic-qoder-plugin/.qoder-plugin/plugin.json`
- Schema guidance: `fractal-agentic/.claude-plugin/PLUGIN_SCHEMA_NOTES.md`
...
- `fractal-agentic-qoder-plugin/.qoder-plugin/plugin.json#L1-L28`
...
- Verification suite and post-install checks: `fractal-agentic/docs/02-install.md`
- Non-blocking policy enforcement patterns: `fractal-agentic/scripts/check-nonblocking-policy.sh`
- General usage and integration: `fractal-agentic/README.md`

**Section sources**
- `fractal-agentic/docs/02-install.md#L187-L198`

...
description: **Referenced Files in This Document** `fractal-agentic/hooks/scripts/pre-bash-safety.js` `fractal-agentic/hooks/scripts/pre-config-protection.js` `fractal-agentic/hooks/scripts/pre-no-verify.js` `frac…
type: item
---
<cite>

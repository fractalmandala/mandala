...
description: **Referenced Files in This Document** `packages/fractal-svelte/package.json` `packages/fractal-svelte/src/lib/index.ts` `packages/fractal-svelte/src/lib/components/agents/index.ts` `packages/fractal-s…
type: item
---
<cite>
...
- `packages/fractal-svelte/src/lib/components/agents/message-bubble/index.ts`
- `packages/fractal-svelte/src/lib/components/agents/message-scroller/index.ts`
- `packages/fractal-svelte/src/lib/components/agents/ai-sidebar/index.ts`
- `packages/fractal-svelte/src/lib/components/agents/prompt-input/index.ts`
- `packages/fractal-svelte/src/lib/components/agents/streaming-response/index.ts`
- `packages/fractal-svelte/src/lib/components/agents/approval-card/index.ts`
- `packages/fractal-svelte/src/lib/components/agents/file-diff/index.ts`
- `packages/fractal-svelte/src/lib/components/agents/todo-list/index.ts`
</cite>
...
- `packages/fractal-svelte/src/lib/components/agents/message-bubble/index.ts#L1-L6`
- `packages/fractal-svelte/src/lib/components/agents/message-scroller/index.ts#L1-L2`
- `packages/fractal-svelte/src/lib/components/agents/ai-sidebar/index.ts#L1-L8`
- `packages/fractal-svelte/src/lib/components/agents/prompt-input/index.ts#L1-L3`
- `packages/fractal-svelte/src/lib/components/agents/streaming-response/index.ts#L1-L7`
- `packages/fractal-svelte/src/lib/components/agents/approval-card/index.ts#L1-L9`
- `packages/fractal-svelte/src/lib/components/agents/file-diff/index.ts#L1-L3`
- `packages/fractal-svelte/src/lib/components/agents/todo-list/index.ts#L1-L3`

...
The repo root is a pnpm monorepo ("fractals") holding everything the author works on — desktop apps, websites, and publishable npm packages. A single workspace manifest (`pnpm-workspace.yaml` ties apps/, sites/, and packages/ together.
...
See the [Apps Module](apps.md), [Sites Module](../cards/sites.md), [Packages Module](packages.md), [Fractal Agentic System](../cards/fractal-agentic.md), [Fractal Wiki Vault](../cards/fractal-wiki-vault.md), [Cabinet 90AI](../cards/cabinet-90ai.md), and [Coding Conventions](../cards/conventions.md) pages for detail.

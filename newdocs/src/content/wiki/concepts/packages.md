...
- **fractal-agentic** — `packages/fractal-agentic`. The grand orchestration system (see [Fractal Agentic System](../cards/fractal-agentic.md)). Packages the agent process under `plugin/`. Language TS, package manager pnpm, add-ons prettier/eslint/sveltekit-adapter/mdsvex.
...
See [Fractal Agentic System](../cards/fractal-agentic.md) for the orchestration depth, and [Coding Conventions](../cards/conventions.md) for the shared SASS/token rules.

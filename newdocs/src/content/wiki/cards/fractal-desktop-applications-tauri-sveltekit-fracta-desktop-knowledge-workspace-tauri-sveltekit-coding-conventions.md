---
title: Fracta Desktop Knowledge Workspace (Tauri + SvelteKit) — Coding Conventions
description: - Every native capability is exposed as a #[tauri::command] function in lib.rs paired with a matching TypeScript wrapper in src/lib/ipc.ts that calls invoke('<commandname', ...) and declares the requ…
tags: [apps/fracta]
type: card
module: apps/fracta
path: apps/fracta

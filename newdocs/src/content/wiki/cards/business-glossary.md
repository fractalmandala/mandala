...
description: - Definition：One of seven domain-specific playbooks (Design, Svelte, Code, Agent, Creator, Workflow, Meta) that an orchestrator selects exactly one of to handle a task. Each boss has its own INDEX.md…
tags: [business_term]
type: card
module: repo
path: repo
...
- Aliases：progression policy、non-blocking rule

...
description: External LLM wiki vault at 100cabinet — raw/wiki/output three-layer architecture, required frontmatter with description, ingest/capture/query/lint ops.
tags: [external, wiki, llm-wiki, knowledge, fractal-wiki, vault]
type: card
module: external/fractal-wiki
path: external/fractal-wiki
created: 2026-08-04
updated: 2026-08-06
---
...
See [Cabinet 90AI](cabinet-90ai.md) (sibling external folder) and [Fractal Agentic System](fractal-agentic.md) (the orchestrator that captures episodes here).

---
title: FractalHome Documentation Site (Blume + Astro) — Coding Conventions
description: - Each content directory contains an INDEX.md file that serves as the section landing page, with individual articles as sibling .md files using kebab-case filenames derived from their titles.

---
title: Fractal Agentic Plugin Documentation, Scripts & Evaluation Suite — Coding Conventions
description: - Shell scripts use set -eu and define local pass() / fail() helpers that print prefixed messages and exit non-zero on failure, keeping output machine-parseable.

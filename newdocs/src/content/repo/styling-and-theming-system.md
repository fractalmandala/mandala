...
description: This document explains the styling and theming system used by Fractalsvelte, focusing on the SASS-based approach, CSS custom properties (variables), and theme customization patterns. It covers how to…
type: item
---

<cite>
**Referenced Files in This Document**
- [index.sass](../../apps/fracta/src/lib/styles/index.sass)
- [_tokens.sass](../../apps/fracta/src/lib/styles/_tokens.sass)
- [_globals.sass](../../apps/fracta/src/lib/styles/_globals.sass)
- [_mixins.sass](../../apps/fracta/src/lib/styles/_mixins.sass)
- [app.css](../../apps/fracta/src/app.css)
- [vite.config.ts](../../apps/fracta/vite.config.ts)
- [theme-template.css](../../packages/fractalsvelte/scripts/oracle/theme-template.css)
- [themes.json](../../packages/fractalsvelte/src/lib/themes.json)
- [themes.ts](../../packages/fractalsvelte/src/lib/themes.ts)
</cite>
...
**Diagram sources**
- [index.sass:1-14](../../apps/fracta/src/lib/styles/index.sass#L1-L14)
- [_tokens.sass:1-161](../../apps/fracta/src/lib/styles/_tokens.sass#L1-L161)
- [_globals.sass:1-67](../../apps/fracta/src/lib/styles/_globals.sass#L1-L67)
- [_mixins.sass:1-25](../../apps/fracta/src/lib/styles/_mixins.sass#L1-L25)
- [app.css:1-2](../../apps/fracta/src/app.css#L1-L2)
- [vite.config.ts:1-14](../../apps/fracta/vite.config.ts#L1-L14)
...
**Diagram sources**
- [_tokens.sass:96-161](../../apps/fracta/src/lib/styles/_tokens.sass#L96-L161)
...
**Section sources**
- [_tokens.sass:96-161](../../apps/fracta/src/lib/styles/_tokens.sass#L96-L161)
- [_globals.sass:26-31](../../apps/fracta/src/lib/styles/_globals.sass#L26-L31)
- [vite.config.ts:6-12](../../apps/fracta/vite.config.ts#L6-L12)
...
**Section sources**
- [_tokens.sass:1-95](../../apps/fracta/src/lib/styles/_tokens.sass#L1-L95)

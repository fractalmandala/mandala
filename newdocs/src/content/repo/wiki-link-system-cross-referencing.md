---
title: Wiki Link System & Cross-Referencing
description: This document explains FractalHome’s wiki-link system and cross-referencing capabilities. It covers how to create internal links between wiki pages, manage connections using CONNECTIONS.ts files, imp…
type: item
---
...
- [CONNECTIONS.ts (Archaeology)](../../sites/fractalmandala/src/content/Archaeology/CONNECTIONS.ts)
- [CONNECTIONS.ts (Design/SvelteKit)](../../sites/fractaldesign/src/routes/CONNECTIONS.ts)
- [INDEX.md (Archaeology)](../../sites/fractalhome/content/Archaeology/INDEX.md)
- [INDEX.md (Civilization)](../../sites/fractalhome/content/Civilization/INDEX.md)
</cite>
...
- [INDEX.md (Archaeology):1-88](../../sites/fractalhome/content/Archaeology/INDEX.md#L1-L88)
- [INDEX.md (Civilization):1-19](../../sites/fractalhome/content/Civilization/INDEX.md#L1-L19)
- [CONNECTIONS.ts (Archaeology):1-432](../../sites/fractalmandala/src/content/Archaeology/CONNECTIONS.ts#L1-L432)
- [CONNECTIONS.ts (Design/SvelteKit):1-498](../../sites/fractaldesign/src/routes/CONNECTIONS.ts#L1-L498)

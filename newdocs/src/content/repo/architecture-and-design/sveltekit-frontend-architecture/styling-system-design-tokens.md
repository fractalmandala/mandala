...
description: **Referenced Files in This Document** `apps/fracta/src/lib/styles/index.sass` `apps/fracta/src/lib/styles/_tokens.sass` `apps/fracta/src/lib/styles/_primitives.sass` `apps/fracta/src/lib/styles/_typog…
type: item
---
<cite>
**Referenced Files in This Document**
- `apps/fracta/src/lib/styles/index.sass`
- `apps/fracta/src/lib/styles/_tokens.sass`
- `apps/fracta/src/lib/styles/_primitives.sass`
- `apps/fracta/src/lib/styles/_typography.sass`
- `apps/fracta/src/lib/styles/_mixins.sass`
- `apps/shradhapp/src/lib/styles/index.sass`
- `apps/shradhapp/src/lib/styles/_tokens.sass`
- `sites/fractalhome/theme.css`
- `sites/fractalhome/BLUME-CUSTOMIZATION-BACKEND.md`
</cite>

...
description: **Referenced Files in This Document** `apps/fracta/src-tauri/Cargo.toml` `apps/fracta/src-tauri/src/main.rs` `apps/fracta/src-tauri/src/lib.rs` `apps/fracta/src-tauri/src/vault.rs` `apps/fracta/src-ta…
type: item
---
<cite>
...
- `apps/shradhapp/src-tauri/src/db.rs#L1-L334`
- `apps/shradhapp/src-tauri/src/media_engine.rs#L1-L800`
...
- `apps/shradhapp/src-tauri/src/lib.rs#L39-L63`
...
**Diagram sources**
- `apps/fracta/src-tauri/src/vault.rs#L22-L54`
- `apps/fracta/src-tauri/src/vault.rs#L73-L278`
...
**Section sources**
- `apps/fracta/src-tauri/src/lib.rs#L1-L497`
- `apps/fracta/src/lib/ipc.ts#L1-L237`
...
**Diagram sources**
- `apps/shradhapp/src-tauri/src/db.rs#L38-L82`
- `apps/shradhapp/src-tauri/src/db.rs#L86-L192`
- `apps/shradhapp/src-tauri/src/db.rs#L196-L303`
...
**Diagram sources**
- `apps/shradhapp/src-tauri/src/media_engine.rs#L256-L412`
...
**Section sources**
- `apps/fracta/src-tauri/src/lib.rs#L194-L207`
- `apps/fracta/src-tauri/src/workspace.rs#L638-L682`
- `apps/shradhapp/src-tauri/src/media_engine.rs#L29-L70`
- `apps/fracta/src-tauri/src/lib.rs#L435-L438`
...
**Section sources**
- `apps/fracta/src-tauri/src/lib.rs#L435-L438`
- `apps/shradhapp/src-tauri/src/lib.rs#L13-L14`
- `apps/fracta/src-tauri/src/lib.rs#L441-L443`
- `apps/shradhapp/src-tauri/src/lib.rs#L29-L36`
...
- `apps/shradhapp/src-tauri/src/media_engine.rs#L75-L106`
...
**Section sources**
- `apps/fracta/src-tauri/src/lib.rs#L182-L188`
- `apps/fracta/src-tauri/src/search.rs#L24-L36`
- `apps/shradhapp/src-tauri/src/media_engine.rs#L75-L106`
- `apps/shradhapp/src-tauri/src/media_engine.rs#L587-L655`

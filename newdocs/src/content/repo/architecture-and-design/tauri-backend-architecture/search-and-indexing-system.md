---
title: Search and Indexing System
description: **Referenced Files in This Document** `apps/fracta/src-tauri/src/search.rs` `apps/fracta/src-tauri/src/workspace.rs` `apps/fracta/src-tauri/src/frontmatter.rs` `apps/fracta/src-tauri/src/gguf.rs` `app…
type: item
---
<cite>
...
- `apps/fracta/src-tauri/src/gguf.rs`
- `apps/fracta/src-tauri/src/autotag.rs`

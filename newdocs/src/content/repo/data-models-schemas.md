...
description: This document provides a comprehensive data model and schema reference for the structured types used across the applications in this repository. It focuses on:
type: item
---

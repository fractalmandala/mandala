---
title: AI Integration (GGUF)
description: This document explains Fracta’s local AI integration using GGUF models. It covers how the application loads a GGUF model via a managed llama-server subprocess, exposes an OpenAI-compatible endpoint o…
type: item
---

<cite>
**Referenced Files in This Document**
- [gguf.rs](../../apps/fracta/src-tauri/src/gguf.rs)
- [lib.rs](../../apps/fracta/src-tauri/src/lib.rs)
- [vault.rs](../../apps/fracta/src-tauri/src/vault.rs)
- [ipc.ts](../../apps/fracta/src/lib/ipc.ts)
- [agent.svelte.ts](../../apps/fracta/src/lib/state/agent.svelte.ts)
- [AgentSettings.svelte](../../apps/fracta/src/lib/components/AgentSettings.svelte)
- [AskPanel.svelte](../../apps/fracta/src/lib/components/AskPanel.svelte)
...
**Diagram sources**
- [AgentSettings.svelte:1-348](../../apps/fracta/src/lib/components/AgentSettings.svelte#L1-L348)
- [agent.svelte.ts:1-236](../../apps/fracta/src/lib/state/agent.svelte.ts#L1-L236)
- [ipc.ts:1-237](../../apps/fracta/src/lib/ipc.ts#L1-L237)
- [lib.rs:398-497](../../apps/fracta/src-tauri/src/lib.rs#L398-L497)
- [gguf.rs:1-321](../../apps/fracta/src-tauri/src/gguf.rs#L1-L321)
...
- [agent.svelte.ts:1-236](../../apps/fracta/src/lib/state/agent.svelte.ts#L1-L236)
- [AgentSettings.svelte:1-348](../../apps/fracta/src/lib/components/AgentSettings.svelte#L1-L348)
- [AskPanel.svelte:1-233](../../apps/fracta/src/lib/components/AskPanel.svelte#L1-L233)
...
**Diagram sources**
- [AgentSettings.svelte:63-85](../../apps/fracta/src/lib/components/AgentSettings.svelte#L63-L85)
- [agent.svelte.ts:172-215](../../apps/fracta/src/lib/state/agent.svelte.ts#L172-L215)
- [ipc.ts:216-237](../../apps/fracta/src/lib/ipc.ts#L216-L237)
- [lib.rs:410-423](../../apps/fracta/src-tauri/src/lib.rs#L410-L423)
- [gguf.rs:131-184](../../apps/fracta/src-tauri/src/gguf.rs#L131-L184)
...
**Diagram sources**
- [gguf.rs:19-80](../../apps/fracta/src-tauri/src/gguf.rs#L19-L80)
- [gguf.rs:51-67](../../apps/fracta/src-tauri/src/gguf.rs#L51-L67)
- [gguf.rs:131-184](../../apps/fracta/src-tauri/src/gguf.rs#L131-L184)
...
**Section sources**
- [vault.rs:210-267](../../apps/fracta/src-tauri/src/vault.rs#L210-L267)
...
**Section sources**
- [gguf.rs:145-148](../../apps/fracta/src-tauri/src/gguf.rs#L145-L148)
- [gguf.rs:211-240](../../apps/fracta/src-tauri/src/gguf.rs#L211-L240)
- [AgentSettings.svelte:186-202](../../apps/fracta/src/lib/components/AgentSettings.svelte#L186-L202)
...
**Section sources**
- [gguf.rs:187-202](../../apps/fracta/src-tauri/src/gguf.rs#L187-L202)
- [agent.svelte.ts:30-38](../../apps/fracta/src/lib/state/agent.svelte.ts#L30-L38)
...
**Section sources**
- [vault.rs:237-241](../../apps/fracta/src-tauri/src/vault.rs#L237-L241)
- [AskPanel.svelte:22-26](../../apps/fracta/src/lib/components/AskPanel.svelte#L22-L26)

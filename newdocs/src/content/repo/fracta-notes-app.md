---
title: Fracta Notes App
description: Fracta is a local-first desktop knowledge management application built with SvelteKit and Tauri. It keeps your notes, documents, data files, search index, and agent context inside a user-chosen proje…
type: item
---

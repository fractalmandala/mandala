...
description: ShradhApp is a local-first desktop video editor built with SvelteKit and Tauri. It provides a friendly media bank, one-click voiceover recording with automatic cleanup, a simple clip assembler, and e…
type: item
---
...
- [DESIGN.md](../../apps/shradhapp/DESIGN.md)
...
- [+page.svelte](../../apps/shradhapp/src/routes/+page.svelte)
- [StudioApp.svelte](../../apps/shradhapp/src/lib/components/StudioApp.svelte)

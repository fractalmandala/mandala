---
title: Personal Knowledge Management Sites
description: This document explains the personal knowledge management sites built within the monorepo: FractalHome (personal wiki), FractalMandala (knowledge base), FractalMem (memory system), and FractalWiki (co…
type: item
---
...
- [package.json](../../sites/fractalmem/package.json)
- [svelte.config.js](../../sites/fractalmem/svelte.config.js)
- [package.json](../../sites/fractalwiki/package.json)
- [svelte.config.js](../../sites/fractalwiki/svelte.config.js)
</cite>

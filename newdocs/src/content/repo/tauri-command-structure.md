---
title: Tauri Command Structure
description: This document explains the Tauri command structure and IPC communication patterns used by the SvelteKit frontends to call Rust commands. It covers how commands are defined, registered, invoked from T…
type: item
---
...
- [main.rs](../../apps/shradhapp/src-tauri/src/main.rs)

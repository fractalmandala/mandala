...
description: This document explains the end-to-end data flow and state management patterns across the Fracta application, which is built with SvelteKit + Svelte 5 + Tauri + TypeScript. It focuses on:
type: item
---
...
- [Workspace.svelte](../../apps/fracta/src/lib/components/Workspace.svelte)
</cite>
...
- [Workspace.svelte:1-788](../../apps/fracta/src/lib/components/Workspace.svelte#L1-L788)
...
- [prefs.svelte.ts:1-75](../../apps/fracta/src/lib/state/prefs.svelte.ts#L1-L75)

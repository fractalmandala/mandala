...
description: This document explains the SvelteKit component system architecture across the monorepo’s Svelte applications, focusing on:
type: item
---
...
- [apps/shradhapp/src/routes/+layout.svelte](../../apps/shradhapp/src/routes/+layout.svelte)
- [sites/fractalagentic/src/routes/+layout.svelte](../../sites/fractalagentic/src/routes/+layout.svelte)
- [sites/fractaldesign/src/routes/+layout.svelte](../../sites/fractaldesign/src/routes/+layout.svelte)
- [apps/fracta/src/lib/state/globalstores.ts](../../apps/fracta/src/lib/state/globalstores.ts)
- [apps/fracta/src/lib/state/prefs.svelte.ts](../../apps/fracta/src/lib/state/prefs.svelte.ts)
- [apps/fracta/src/lib/components/Counter.svelte](../../apps/fracta/src/lib/components/Counter.svelte)
- [apps/fracta/src/lib/components/app-nav.svelte](../../apps/fracta/src/lib/components/app-nav.svelte)
- [sites/fractalagentic/src/lib/components/Card.svelte](../../sites/fractalagentic/src/lib/components/Card.svelte)
- [sites/fractaldesign/src/lib/states/nativestate.svelte.ts](../../sites/fractaldesign/src/lib/states/nativestate.svelte.ts)
</cite>
...
- [apps/fracta/src/lib/components/Counter.svelte:1-6](../../apps/fracta/src/lib/components/Counter.svelte#L1-L6)
- [apps/fracta/src/lib/components/app-nav.svelte:1-47](../../apps/fracta/src/lib/components/app-nav.svelte#L1-L47)
- [apps/fracta/src/lib/state/globalstores.ts:1-4](../../apps/fracta/src/lib/state/globalstores.ts#L1-L4)
- [apps/fracta/src/lib/state/prefs.svelte.ts:1-75](../../apps/fracta/src/lib/state/prefs.svelte.ts#L1-L75)
- [apps/shradhapp/src/routes/+layout.svelte:1-16](../../apps/shradhapp/src/routes/+layout.svelte#L1-L16)
- [sites/fractalagentic/src/routes/+layout.svelte:1-126](../../sites/fractalagentic/src/routes/+layout.svelte#L1-L126)
- [sites/fractalagentic/src/lib/components/Card.svelte:1-108](../../sites/fractalagentic/src/lib/components/Card.svelte#L1-L108)
- [sites/fractaldesign/src/routes/+layout.svelte:1-62](../../sites/fractaldesign/src/routes/+layout.svelte#L1-L62)
- [sites/fractaldesign/src/lib/states/nativestate.svelte.ts:1-68](../../sites/fractaldesign/src/lib/states/nativestate.svelte.ts#L1-L68)

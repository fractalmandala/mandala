...
description: This document explains the development workflow for a pnpm monorepo that hosts multiple SvelteKit sites, Tauri desktop apps, and shared packages. It covers how to work with pnpm workspaces, manage de…
type: item
---
...
- [apps/fracta/playwright.config.ts](../../apps/fracta/playwright.config.ts)
...
- [apps/fracta/playwright.config.ts:1-22](../../apps/fracta/playwright.config.ts#L1-L22)

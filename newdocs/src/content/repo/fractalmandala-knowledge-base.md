---
title: FractalMandala - Knowledge Base
description: FractalMandala is an advanced knowledge base and wiki site built with SvelteKit, designed to visualize relationships across knowledge domains through a graph system and maintain consistency across mu…
type: item
---

<cite>
**Referenced Files in This Document**
- [README.md](../../sites/fractalmandala/README.md)
- [package.json](../../sites/fractalmandala/package.json)
- [svelte.config.js](../../sites/fractalmandala/svelte.config.js)
- [vite.config.ts](../../sites/fractalmandala/vite.config.ts)
- [tsconfig.json](../../sites/fractalmandala/tsconfig.json)
- [sync-banks.mjs](../../sites/fractalmandala/scripts/sync-banks.mjs)
- [src/app.html](../../sites/fractalmandala/src/app.html)
- [src/app.d.ts](../../sites/fractalmandala/src/app.d.ts)
- [src/routes/+layout.svelte](../../sites/fractalmandala/src/routes/+layout.svelte)
- [src/routes/+page.svelte](../../sites/fractalmandala/src/routes/+page.svelte)
- [src/lib/index.ts](../../sites/fractalmandala/src/lib/index.ts)
- [static/graphs/README.md](../../sites/fractalmandala/static/graphs/README.md)
</cite>

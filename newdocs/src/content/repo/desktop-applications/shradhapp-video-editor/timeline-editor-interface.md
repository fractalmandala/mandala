...
description: **Referenced Files in This Document** `apps/shradhapp/README.md` `apps/shradhapp/src/lib/timeline/index.ts` `apps/shradhapp/src/lib/timeline/model.ts` `apps/shradhapp/src/lib/timeline/editor-adapter.t…
type: item
---
<cite>
**Referenced Files in This Document**
- `apps/shradhapp/README.md`
- `apps/shradhapp/src/lib/timeline/index.ts`
- `apps/shradhapp/src/lib/timeline/model.ts`
- `apps/shradhapp/src/lib/timeline/editor-adapter.ts`
- `apps/shradhapp/src/lib/timeline/mapper.ts`
- `apps/shradhapp/svelte-video-editor-ref/src/lib/index.ts`
- `apps/shradhapp/svelte-video-editor-ref/README.md`
</cite>
...
**Diagram sources**
- `apps/shradhapp/src/lib/timeline/index.ts#L1-L3`
- `apps/shradhapp/src/lib/timeline/model.ts#L1-L106`
- `apps/shradhapp/src/lib/timeline/mapper.ts#L1-L247`
- `apps/shradhapp/src/lib/timeline/editor-adapter.ts#L1-L198`
- `apps/shradhapp/svelte-video-editor-ref/src/lib/index.ts#L1-L110`
- `apps/shradhapp/svelte-video-editor-ref/README.md#L1-L578`

**Section sources**
- `apps/shradhapp/README.md#L1-L126`
- `apps/shradhapp/src/lib/timeline/index.ts#L1-L3`
- `apps/shradhapp/src/lib/timeline/model.ts#L1-L106`
- `apps/shradhapp/src/lib/timeline/mapper.ts#L1-L247`
- `apps/shradhapp/src/lib/timeline/editor-adapter.ts#L1-L198`

...
description: **Referenced Files in This Document** `apps/shradhapp/src-tauri/src/db.rs` `apps/shradhapp/src-tauri/src/commands.rs` `apps/shradhapp/src-tauri/src/media_engine.rs` `apps/shradhapp/src-tauri/src/lib.r…
type: item
---
<cite>
...
- `apps/shradhapp/docs/developer/05-data-model-and-project-format.md`
- `apps/shradhapp/docs/developer/03-rust-backend.md`
- `apps/shradhapp/docs/developer/04-frontend.md`
...
- `apps/shradhapp/src-tauri/src/media_engine.rs#L1-L110`
- `apps/shradhapp/src/lib/backend/types.ts#L1-L173`
- `apps/shradhapp/src/lib/backend/tauri.ts#L1-L105`

**Section sources**
- `apps/shradhapp/docs/developer/03-rust-backend.md#L1-L60`
- `apps/shradhapp/docs/developer/04-frontend.md#L1-L60`
...
**Section sources**
- `apps/shradhapp/src-tauri/src/db.rs#L1-L82`
- `apps/shradhapp/src-tauri/src/commands.rs#L777-L998`
...
**Diagram sources**
- `apps/shradhapp/src/lib/backend/tauri.ts#L73-L77`
- `apps/shradhapp/src-tauri/src/commands.rs#L914-L973`
- `apps/shradhapp/src-tauri/src/db.rs#L196-L267`
...
**Diagram sources**
- `apps/shradhapp/src-tauri/src/db.rs#L52-L81`
- `apps/shradhapp/docs/developer/05-data-model-and-project-format.md#L26-L63`
...
**Diagram sources**
- `apps/shradhapp/src-tauri/src/commands.rs#L777-L836`
- `apps/shradhapp/src-tauri/src/commands.rs#L804-L836`
- `apps/shradhapp/src-tauri/src/commands.rs#L838-L890`
- `apps/shradhapp/src/lib/backend/types.ts#L19-L42`

**Section sources**
- `apps/shradhapp/src-tauri/src/commands.rs#L777-L998`
- `apps/shradhapp/docs/developer/05-data-model-and-project-format.md#L64-L102`
- `apps/shradhapp/src/lib/backend/types.ts#L19-L42`
...
**Diagram sources**
- `apps/shradhapp/src-tauri/src/commands.rs#L914-L973`
- `apps/shradhapp/src-tauri/src/db.rs#L217-L242`

**Section sources**
- `apps/shradhapp/src-tauri/src/commands.rs#L914-L998`
- `apps/shradhapp/src-tauri/src/db.rs#L196-L267`
...
**Section sources**
- `apps/shradhapp/docs/developer/05-data-model-and-project-format.md#L10-L24`
...
**Section sources**
- `apps/shradhapp/docs/developer/04-frontend.md#L98-L106`
- `apps/shradhapp/src-tauri/src/commands.rs#L949-L973`
- `apps/shradhapp/src-tauri/src/db.rs#L217-L242`
...
**Diagram sources**
- `apps/shradhapp/src/lib/backend/tauri.ts#L82-L94`
- `apps/shradhapp/src-tauri/src/commands.rs#L1016-L1129`
- `apps/shradhapp/src-tauri/src/media_engine.rs#L252-L412`

**Section sources**
- `apps/shradhapp/docs/developer/03-rust-backend.md#L85-L127`
- `apps/shradhapp/src-tauri/src/media_engine.rs#L252-L412`
- `apps/shradhapp/src-tauri/src/commands.rs#L1016-L1129`
...
**Section sources**
- `apps/shradhapp/src-tauri/src/commands.rs#L599-L612`
- `apps/shradhapp/src-tauri/src/commands.rs#L925-L998`
- `apps/shradhapp/src/lib/backend/types.ts#L114-L173`
- `apps/shradhapp/src/lib/backend/tauri.ts#L73-L94`
...
**Section sources**
- `apps/shradhapp/docs/developer/03-rust-backend.md#L128-L159`
- `apps/shradhapp/src-tauri/src/commands.rs#L1016-L1129`
...
**Section sources**
- `apps/shradhapp/src-tauri/src/commands.rs#L914-L998`
- `apps/shradhapp/src-tauri/src/commands.rs#L1016-L1194`
- `apps/shradhapp/src/lib/backend/types.ts#L138-L173`
- `apps/shradhapp/src/lib/backend/tauri.ts#L73-L94`
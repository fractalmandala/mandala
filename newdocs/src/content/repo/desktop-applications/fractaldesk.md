---
title: FractalDesk
description: **Referenced Files in This Document** `README.md` `package.json` `pnpm-workspace.yaml` `apps/fractaldesk/AGENTS.md` `apps/fracta/package.json` `apps/shradhapp/package.json`
type: item
---
<cite>
...
**Section sources**
- `apps/fracta/package.json#L21-L34`
- `apps/shradhapp/package.json#L15-L30`
- `apps/fractaldesk/AGENTS.md#L1-L17`

...
description: This document explains the document preview functionality in Fracta, focusing on how PDF and DOCX files are parsed and rendered locally. It covers:
type: item
---
...
- [PdfViewer.svelte](../../apps/fracta/src/lib/components/PdfViewer.svelte)
- [DocxImage.svelte](../../apps/fracta/src/lib/components/DocxImage.svelte)

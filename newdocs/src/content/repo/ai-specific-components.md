...
description: This document explains the AI-focused UI components in Fractalsvelte, including Conversation, Message, Code, Artifact, and related elements. It covers real-time streaming updates, markdown rendering,…
type: item
---

<cite>
**Referenced Files in This Document**
- [index.ts](../../packages/fractal-svelte/src/lib/components/agents/index.ts)
- [message.svelte](../../packages/fractal-svelte/src/lib/components/agents/message/message.svelte)
- [streaming-response.svelte](../../packages/fractal-svelte/src/lib/components/agents/streaming-response/streaming-response.svelte)
- [prompt-input.svelte](../../packages/fractal-svelte/src/lib/components/agents/prompt-input/prompt-input.svelte)
- [message-bubble.svelte](../../packages/fractal-svelte/src/lib/components/agents/message-bubble/message-bubble.svelte)
- [message-scroller.svelte](../../packages/fractal-svelte/src/lib/components/agents/message-scroller/message-scroller.svelte)
- [RenderedMarkdown.svelte](../../apps/fracta/src/lib/components/RenderedMarkdown.svelte)
- [markdown.ts](../../apps/fracta/src/lib/markdown.ts)
- [code.svelte](../../packages/fractalsvelte/src/lib/components/ai-elements/code/code.svelte)
</cite>
...
**Section sources**
- [message.svelte:1-24](../../packages/fractal-svelte/src/lib/components/agents/message/message.svelte#L1-L24)
- [message-bubble.svelte:1-41](../../packages/fractal-svelte/src/lib/components/agents/message-bubble/message-bubble.svelte#L1-L41)
- [message-scroller.svelte:1-96](../../packages/fractal-svelte/src/lib/components/agents/message-scroller/message-scroller.svelte#L1-L96)
- [prompt-input.svelte:1-141](../../packages/fractal-svelte/src/lib/components/agents/prompt-input/prompt-input.svelte#L1-L141)
- [streaming-response.svelte:1-129](../../packages/fractal-svelte/src/lib/components/agents/streaming-response/streaming-response.svelte#L1-L129)
- [RenderedMarkdown.svelte:1-185](../../apps/fracta/src/lib/components/RenderedMarkdown.svelte#L1-L185)
- [markdown.ts:1-207](../../apps/fracta/src/lib/markdown.ts#L1-L207)
- [code.svelte:1-36](../../packages/fractalsvelte/src/lib/components/ai-elements/code/code.svelte#L1-L36)
...
**Diagram sources**
- [index.ts:1-10](../../packages/fractal-svelte/src/lib/components/agents/index.ts#L1-L10)

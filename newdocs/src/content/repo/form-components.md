...
description: This document provides comprehensive documentation for form-related components in Fractalsvelte, focusing on the Form primitives built with formsnap and the Field system used to structure and present…
type: item
---
...
- [field/index.ts](../../packages/fractalsvelte/src/lib/components/field/index.ts)
- [input/index.ts](../../packages/fractalsvelte/src/lib/components/input/index.ts)
- [select/index.ts](../../packages/fractalsvelte/src/lib/components/select/index.ts)
- [textarea/index.ts](../../packages/fractalsvelte/src/lib/components/textarea/index.ts)
</cite>
...
- [field/index.ts:1-51](../../packages/fractalsvelte/src/lib/components/field/index.ts#L1-L51)
- [input/index.ts:1-10](../../packages/fractalsvelte/src/lib/components/input/index.ts#L1-L10)
- [textarea/index.ts:1-10](../../packages/fractalsvelte/src/lib/components/textarea/index.ts#L1-L10)
- [select/index.ts:1-52](../../packages/fractalsvelte/src/lib/components/select/index.ts#L1-L52)

**Section sources**
- [form/index.ts:1-41](../../packages/fractalsvelte/src/lib/components/form/index.ts#L1-L41)
- [field/index.ts:1-51](../../packages/fractalsvelte/src/lib/components/field/index/index.ts#L1-L51)
- [input/index.ts:1-10](../../packages/fractalsvelte/src/lib/components/input/index.ts#L1-L10)
- [textarea/index.ts:1-10](../../packages/fractalsvelte/src/lib/components/textarea/index.ts#L1-L10)
- [select/index.ts:1-52](../../packages/fractalsvelte/src/lib/components/select/index.ts#L1-L52)

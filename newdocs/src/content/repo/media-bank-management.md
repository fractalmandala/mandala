...
description: This document explains the media bank management system in ShradhApp, focusing on the Rust backend media engine and the Tauri command surface that connects the Svelte frontend to native file operatio…
type: item
---
...
- [02-media-bank.md](../../apps/shradhapp/docs/user/02-media-bank.md)
...
- [media_engine.rs (tests)](../../apps/shradhapp/src-tauri/tests/media_engine.rs)
</cite>

...
description: Morphicons Svelte provides Svelte 5 bindings for morphing SVG icons with SSR-safe initial paths and a browser-owned morph driver after mount. It exposes a single, flexible icon component that can ren…
type: item
---

<cite>
**Referenced Files in This Document**
- [package.json](../../packages/morphicons-svelte/package.json)
- [README.md](../../packages/morphicons-svelte/README.md)
- [index.ts](../../packages/morphicons-svelte/src/lib/index.ts)
- [MorphIcon.svelte](../../packages/morphicons-svelte/src/lib/MorphIcon.svelte)
- [MenuCloseIcon.svelte](../../packages/morphicons-svelte/src/lib/icons/MenuCloseIcon.svelte)
- [PlayPauseIcon.svelte](../../packages/morphicons-svelte/src/lib/icons/PlayPauseIcon.svelte)
- [paths.ts](../../packages/morphicons-svelte/src/lib/icons/paths.ts)
- [vite.config.ts](../../packages/morphicons-svelte/vite.config.ts)
- [svelte.config.js](../../packages/morphicons-svelte/svelte.config.js)
- [tsconfig.json](../../packages/morphicons-svelte/tsconfig.json)
- [MorphIcon.browser.test.ts](../../packages/morphicons-svelte/tests/MorphIcon.browser.test.ts)
- [MorphIcon.ssr.test.ts](../../packages/morphicons-svelte/tests/MorphIcon.ssr.test.ts)
</cite>
...
**Diagram sources**
- [package.json:1-59](../../packages/morphicons-svelte/package.json#L1-L59)
- [index.ts:1-18](../../packages/morphicons-svelte/src/lib/index.ts#L1-L18)
- [MorphIcon.svelte:1-232](../../packages/morphicons-svelte/src/lib/MorphIcon.svelte#L1-L232)
- [MenuCloseIcon.svelte:1-22](../../packages/morphicons-svelte/src/lib/icons/MenuCloseIcon.svelte#L1-L22)
- [PlayPauseIcon.svelte:1-22](../../packages/morphicons-svelte/src/lib/icons/PlayPauseIcon.svelte#L1-L22)
- [paths.ts:1-5](../../packages/morphicons-svelte/src/lib/icons/paths.ts#L1-L5)
- [vite.config.ts:1-12](../../packages/morphicons-svelte/vite.config.ts#L1-L12)
- [svelte.config.js:1-13](../../packages/morphicons-svelte/svelte.config.js#L1-L13)
- [tsconfig.json:1-15](../../packages/morphicons-svelte/tsconfig.json#L1-L15)
...
**Diagram sources**
- [MorphIcon.svelte:40-205](../../packages/morphicons-svelte/src/lib/MorphIcon.svelte#L40-L205)
...
**Section sources**
- [MorphIcon.browser.test.ts:1-114](../../packages/morphicons-svelte/tests/MorphIcon.browser.test.ts#L1-L114)
- [MorphIcon.ssr.test.ts:1-98](../../packages/morphicons-svelte/tests/MorphIcon.ssr.test.ts#L1-L98)
...
**Section sources**
- [package.json:27-33](../../packages/morphicons-svelte/package.json#L27-L33)
- [vite.config.ts:1-12](../../packages/morphicons-svelte/vite.config.ts#L1-L12)
- [svelte.config.js:1-13](../../packages/morphicons-svelte/svelte.config.js#L1-L13)
- [tsconfig.json:1-15](../../packages/morphicons-svelte/tsconfig.json#L1-L15)
...
**Section sources**
- [README.md:15-55](../../packages/morphicons-svelte/README.md#L15-L55)

...
description: This document explains the voiceover recording system in ShradhApp. It covers how audio is captured in the browser, saved via Tauri commands, processed with FFmpeg for cleanup and waveform generation…
type: item
---

<cite>
**Referenced Files in This Document**
- [Recorder.svelte](../../apps/shradhapp/src/lib/components/Recorder.svelte)
- [RecordPanel.svelte](../../apps/shradhapp/src/lib/components/RecordPanel.svelte)
- [commands.rs](../../apps/shradhapp/src-tauri/src/commands.rs)
- [media_engine.rs](../../apps/shradhapp/src-tauri/src/media_engine.rs)
- [03-recording-voiceovers.md](../../apps/shradhapp/docs/user/03-recording-voiceovers.md)
</cite>

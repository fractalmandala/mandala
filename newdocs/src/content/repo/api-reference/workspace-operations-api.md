...
description: **Referenced Files in This Document** `apps/fracta/src-tauri/src/workspace.rs` `apps/fracta/src-tauri/src/lib.rs` `apps/fracta/src-tauri/src/vault.rs`
type: item
---
<cite>
...
- `apps/fracta/src-tauri/src/workspace.rs#L470-L551`
...
**Diagram sources**
- `apps/fracta/src-tauri/src/workspace.rs#L21-L41`
...
**Diagram sources**
- `apps/fracta/src-tauri/src/workspace.rs#L573-L659`
- `apps/fracta/src-tauri/src/lib.rs#L290-L318`
...
**Diagram sources**
- `apps/fracta/src-tauri/src/lib.rs#L137-L165`
...
**Diagram sources**
- `apps/fracta/src-tauri/src/workspace.rs#L92-L116`
...
- `apps/fracta/src-tauri/src/workspace.rs#L1060-L1136`
...
**Diagram sources**
- `apps/fracta/src-tauri/src/lib.rs#L1-L21`

...
description: **Referenced Files in This Document** `apps/fracta/src-tauri/src/lib.rs` `apps/fracta/src/lib/ipc.ts` `apps/fracta/src-tauri/tauri.conf.json` `apps/fracta/src-tauri/capabilities/default.json` `apps/sh…
type: item
---
<cite>
...
- `apps/shradhapp/src-tauri/src/commands.rs#L1-L1357`
...
**Section sources**
- `apps/fracta/src-tauri/src/lib.rs#L42-L497`
- `apps/fracta/src/lib/ipc.ts#L1-L237`
- `apps/shradhapp/src-tauri/src/lib.rs#L10-L66`
- `apps/shradhapp/src-tauri/src/commands.rs#L1-L1357`
...
- `apps/shradhapp/src-tauri/src/lib.rs#L39-L64`
- `apps/fracta/src/lib/ipc.ts#L1-L237`
...
**Diagram sources**
- `apps/fracta/src-tauri/src/lib.rs#L42-L396`
...
**Diagram sources**
- `apps/shradhapp/src-tauri/src/commands.rs#L1132-L1194`

**Section sources**
- `apps/shradhapp/src-tauri/src/commands.rs#L1-L1357`
- `apps/shradhapp/src-tauri/src/lib.rs#L10-L66`
- `apps/shradhapp/src-tauri/tauri.conf.json#L31-L36`
- `apps/shradhapp/src-tauri/capabilities/default.json#L6-L16`
...
**Diagram sources**
- `apps/fracta/src-tauri/Cargo.toml#L17-L44`
- `apps/shradhapp/src-tauri/Cargo.toml#L15-L27`

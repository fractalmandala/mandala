...
description: **Referenced Files in This Document** `apps/fracta/src/lib/ipc.ts` `apps/fracta/src-tauri/src/main.rs` `apps/fracta/src-tauri/src/lib.rs` `apps/fracta/src-tauri/tauri.conf.json` `apps/shradhapp/src-ta…
type: item
---
<cite>

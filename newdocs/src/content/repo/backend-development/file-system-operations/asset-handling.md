...
description: **Referenced Files in This Document** `apps/fracta/src-tauri/src/lib.rs` `apps/fracta/src-tauri/src/workspace.rs`
type: item
---
<cite>
...
**Diagram sources**
- `apps/fracta/src-tauri/src/lib.rs#L105-L132`
- `apps/fracta/src-tauri/src/workspace.rs`
...
**Section sources**
- `apps/fracta/src-tauri/src/lib.rs#L115-L132`
...
**Section sources**
- `apps/fracta/src-tauri/src/lib.rs#L111-L113`
...
**Section sources**
- `apps/fracta/src-tauri/src/lib.rs#L115-L118`
...
**Section sources**
- `apps/fracta/src-tauri/src/lib.rs#L120-L123`

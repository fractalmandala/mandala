...
description: **Referenced Files in This Document** `apps/fracta/src-tauri/src/vault.rs` `apps/fracta/src-tauri/src/workspace.rs` `apps/fracta/src-tauri/src/lib.rs` `apps/fracta/src-tauri/src/main.rs` `apps/fracta/…
type: item
---
<cite>
...
- `apps/fracta/src-tauri/src/lib.rs#L432-L497`
- `apps/fracta/src-tauri/src/vault.rs#L1-L120`
...
**Section sources**
- `apps/fracta/src-tauri/src/vault.rs#L113-L126`
- `apps/fracta/src-tauri/src/workspace.rs#L143-L173`
...
- `apps/fracta/src-tauri/src/lib.rs#L106-L108`
...
**Diagram sources**
- `apps/fracta/src-tauri/src/vault.rs#L21-L24`
- `apps/fracta/src-tauri/src/vault.rs#L73-L126`
...
- `apps/fracta/src-tauri/src/workspace.rs#L553-L571`
...
**Diagram sources**
- `apps/fracta/src-tauri/src/workspace.rs#L638-L659`

**Section sources**
- `apps/fracta/src-tauri/src/workspace.rs#L638-L659`
- `apps/fracta/src-tauri/src/workspace.rs#L661-L682`
- `apps/fracta/src-tauri/src/workspace.rs#L593-L599`
...
- `apps/fracta/src-tauri/tauri.conf.json#L32-L34`
- `apps/fracta/src-tauri/capabilities/default.json#L1-L15`
- `apps/fracta/src/lib/ipc.ts#L149-L178`
...
**Diagram sources**
- `apps/fracta/src-tauri/src/lib.rs#L1-L6`
- `apps/fracta/src-tauri/src/workspace.rs#L7-L16`
- `apps/fracta/src-tauri/src/search.rs#L4-L13`

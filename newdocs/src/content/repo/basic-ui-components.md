...
description: This document explains the basic UI components in Fractalsvelte: Button, Input, Checkbox, and Switch. It covers props, events, styling options, accessibility features, Svelte 5 runes integration, Typ…
type: item
---
...
- [button.sass](../../packages/fractalsvelte/src/lib/components/button/button.sass)
- [input.svelte](../../packages/fractalsvelte/src/lib/components/input/input.svelte)
- [checkbox.svelte](../../packages/fractalsvelte/src/lib/components/checkbox/checkbox.svelte)
- [checkbox.sass](../../packages/fractalsvelte/src/lib/components/checkbox/checkbox.sass)
- [switch.svelte](../../packages/fractalsvelte/src/lib/components/switch/switch.svelte)
- [switch.sass](../../packages/fractalsvelte/src/lib/components/switch/switch.sass)
- [types.ts](../../packages/fractalsvelte/src/lib/types.ts)
- [utils.ts](../../packages/fractalsvelte/src/lib/utils.ts)
</cite>

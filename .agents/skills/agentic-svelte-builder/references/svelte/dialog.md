...
A controlled Modal Dialog component powered by **Svelte 5 Runes** (`$state`, `$bindable`, `$effect`, `$props`). Features body scroll locking via `$effect()`, focus traps, and smooth open/close bindings.

...
Seeding needs an initialized project — run [`ok init`](../get-started/quickstart.mdx) first. Pick **Plain notes** in the starter-pack picker, or run:
...
- **[Claude Code](../integrations/claude-code.mdx)**, **[Cursor](../integrations/cursor.mdx)**, **[Codex](../integrations/codex.mdx)**, **[OpenCode](../integrations/opencode.mdx).** MCP-capable agent hosts.

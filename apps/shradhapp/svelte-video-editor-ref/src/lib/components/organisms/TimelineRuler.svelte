...
<div
	class="sticky top-0 z-30 flex h-7 w-full overflow-x-clip border-b border-border/60 bg-muted/25"
>
	<div
		class="sticky left-0 z-10 h-full shrink-0 border-r border-border/60 bg-muted/35"
	...
	>
		...
		{#each ticks as tick (tick)}
			...
			>
				...
				<div class="h-1.5 w-px bg-border/70"></div>
			</div>
		{/each}

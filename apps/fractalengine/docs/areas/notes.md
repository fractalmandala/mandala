...
| File | Description |
|---|---|
| [`NotesEditor.svelte`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/notes/components/NotesEditor.svelte) | TipTap WYSIWYG editor with raw markdown split pane, toolbar, and slash commands. |
| [`NotesLayout.svelte`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/notes/components/NotesLayout.svelte) | Dedicated Markdown Notes & Wiki workspace layout with draggable resizing |
| [`NotesSidebar1.svelte`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/notes/components/NotesSidebar1.svelte) | NotesSidebar1.svelte |
| [`NotesSidebar2.svelte`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/notes/components/NotesSidebar2.svelte) | NotesSidebar2.svelte |
| [`NotesWorkspaceShell.svelte`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/notes/components/shell/NotesWorkspaceShell.svelte) | NotesWorkspaceShell.svelte |
| [`VaultTreeNode.svelte`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/notes/components/VaultTreeNode.svelte) | VaultTreeNode.svelte |
| [`contributions.ts`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/notes/contributions.ts) | contributions.ts |
| [`frontmatter.ts`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/notes/frontmatter.ts) | frontmatter.ts |
| [`notes.svelte.ts`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/notes/state/notes.svelte.ts) | notes.svelte.ts |
| [`_notes.sass`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/notes/styles/_notes.sass) | Notes & Wiki Layout — dedicated workspace for markdown notes |

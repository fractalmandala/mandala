...
| File | Description |
|---|---|
| [`CanvasGrid.svelte`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/newdesign/components/CanvasGrid.svelte) | CanvasGrid.svelte |
| [`CanvasGridControls.svelte`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/newdesign/components/CanvasGridControls.svelte) | CanvasGridControls.svelte |
| [`CanvasPatternSelect.svelte`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/newdesign/components/CanvasPatternSelect.svelte) | Artwork (gradients + masks) goes on the inner layer so masks never fade the base color. |
| [`CanvasUnit.svelte`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/newdesign/components/CanvasUnit.svelte) | CanvasUnit.svelte |
| [`unit.svelte`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/newdesign/components/unit.svelte) | unit.svelte |
| [`canvasPatterns.ts`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/newdesign/data/canvasPatterns.ts) | Light geometric canvas background patterns extracted from vendors/patterns/data/patterns.ts |
| [`canvasGrid.svelte.ts`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/newdesign/state/canvasGrid.svelte.ts) | canvasGrid.svelte.ts |
| [`newdesign.svelte.ts`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/newdesign/state/newdesign.svelte.ts) | newdesign.svelte.ts |
| [`_newdesign.sass`](file:////Users/amrit/fractals/apps/fractalengine/src/lib/modules/newdesign/styles/_newdesign.sass) | _newdesign.sass |

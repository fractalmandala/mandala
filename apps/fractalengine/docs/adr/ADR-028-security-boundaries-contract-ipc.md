...
# ADR-028: Security Boundaries & Contract-Typed IPC
...
- [ADR-027: Data Layer — In-Memory Mock Engine & Search Index](file:///Users/amrit/fractals/apps/fractalengine/docs/adr/ADR-027-data-layer-mock-engine.md)
- [SECURITY-CONTRACT-PLAN.md](../../SECURITY-CONTRACT-PLAN.md)

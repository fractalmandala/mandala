...
# ADR-004: Single IPC Gateway Module for All Tauri API Calls
...
We will route all Tauri API calls through a single gateway module at [`src/lib/ipc.ts`](file:///Users/amrit/fractals/apps/fractalengine/src/lib/ipc.ts). This module:
...
3.  Maintains a parallel mock module at [`src/lib/ipc-mock.ts`](file:///Users/amrit/fractals/apps/fractalengine/src/lib/ipc-mock.ts) that implements the same interface using an in-memory virtual filesystem.

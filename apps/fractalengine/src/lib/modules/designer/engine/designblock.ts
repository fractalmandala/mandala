...
import type { DraggableOptions, DragDropState } from '$lib/modules/designer/engine/designtypes';
import { startAutoScroll, stopAutoScroll } from '$lib/modules/designer/engine/autoscroll';

<script lang="ts">
	import * as AspectRatio from "$lib/newelements/ui/aspect-ratio/index";
	import * as Dialog from "$lib/newelements/ui/dialog";
	import { getAttachmentsContext } from "../context/attachments.svelte";

---
title: Typography
description: The Typography component provides heading and body text primitives wrapping native HTML tags (h1-h6, p, blockquote, code), styled with fractals-styler primitives…
---

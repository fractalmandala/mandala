---
title: Badge
description: The Badge component renders small status indicators, tags, or count pills using native inline HTML (span or mark), styled with fractals-styler primitives (row, ycenter,…
---

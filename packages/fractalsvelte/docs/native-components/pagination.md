---
title: Pagination
description: The Pagination component renders page selection controls natively using HTML a links (?page=N), styled with fractals-styler primitives (row, ycenter, gap4, width36,…
---

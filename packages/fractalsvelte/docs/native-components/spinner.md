---
title: Spinner
description: "The Spinner component renders loading indicators using an SVG icon animated with pure CSS @keyframes rotate. Sizes use CUBE data-size attributes."
---

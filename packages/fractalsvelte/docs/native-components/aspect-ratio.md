---
title: Aspect Ratio
description: The Aspect Ratio component enforces a specific width-to-height ratio for contained media using CSS aspect-ratio, styled with fractals-styler utility classes (w100, h100).
---

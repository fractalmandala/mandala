---
title: Card
description: The Card component creates styled content containers using semantic HTML (article, header, footer), styled with fractals-styler primitives (box, w100, radius8, bdr,…
---

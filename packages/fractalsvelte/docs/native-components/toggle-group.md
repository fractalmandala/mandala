---
title: Toggle Group
description: The Toggle Group component manages toggle option groups using fieldset and radio inputs, styled with fractals-styler primitives (row, ycenter, pad4, pad6, padleft12,…
---

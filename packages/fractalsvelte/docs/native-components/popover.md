---
title: Popover
description: The Popover component creates floating contextual popups natively using the HTML Popover API (popover attribute) and CSS Anchor Positioning, styled with fractals-styler…
---
...
<div style="position: relative; anchor-name: --popover-anchor; display: inline-block;">

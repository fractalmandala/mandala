---
title: Carousel
description: The Carousel component provides horizontal sliding natively using CSS scroll-snap-type - x mandatory, styled with fractals-styler primitives (w100, row, gap16, padbot8).
---

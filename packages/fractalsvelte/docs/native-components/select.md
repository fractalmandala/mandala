---
title: Select
description: "The Select component leverages modern CSS appearance: base-select (Customizable Native Select) to allow HTML option styling, styled with fractals-styler primitives…"
---

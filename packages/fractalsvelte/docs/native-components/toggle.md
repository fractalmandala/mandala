---
title: Toggle
description: The Toggle component styles a checkbox (input) as a pressable button, styled with fractals-styler primitives (row, ycenter, xcenter, pad8, radius6).
---

---
title: Avatar
description: The Avatar component displays user images or initial fallbacks, styled with fractals-styler primitives (row, xcenter, ycenter, radiusfull, text-sm, bold).
---

---
title: Input
description: "The Input component wraps standard HTML input with Svelte 5 two-way state binding (bind:value), styled with fractals-styler primitives (w100, pad8, padleft12,…"
---

---
title: Radio Group
description: The Radio Group component structures mutually exclusive option choices using fieldset and input, styled with fractals-styler primitives (box, row, ycenter, gap8,…
---

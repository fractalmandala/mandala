---
title: Native Select
description: "The Native Select component wraps HTML select with Svelte 5 state binding (bind:value), styled with fractals-styler primitives (row, ycenter, w100, pad8, padleft12,…"
---

---
title: Checkbox
description: The Checkbox component wraps native HTML input with Svelte 5 two-way state binding (bind:checked), styled with fractals-styler primitives (row, ycenter, gap8, radius4
---

---
title: Tabs
description: "The Tabs component provides tabbed content switching natively using hidden radio inputs and CSS:checked /:has() selectors, styled with fractals-styler primitives (box,…"
---

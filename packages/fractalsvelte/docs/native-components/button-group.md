---
title: Button Group
description: The Button Group component joins multiple buttons using fractals-styler layout primitives (row, ycenter) with collapsed border-radius styling.
---

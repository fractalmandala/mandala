---
title: Carousel
description: An interactive Carousel component powered by **Svelte 5 Runes** (`$state`, `$derived`, `$effect`, `$props`). Manages active slide index, auto-play timers, and prev/next slide navigation controls seamlessly.
---

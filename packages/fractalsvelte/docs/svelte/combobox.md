---
title: Combobox
description: A search-filterable Combobox / Command Palette component powered by **Svelte 5 Runes** (`$state`, `$derived`, `$props`). Features fuzzy query filtering via `$derived()`, keyboard arrow traversal, and dynamic option selection.
---

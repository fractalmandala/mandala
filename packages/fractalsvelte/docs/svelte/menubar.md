---
title: Menubar
description: A desktop-style top Menubar component powered by **Svelte 5 Runes** (`$state`, `$props`). Features horizontal ARIA keyboard arrow key navigation across top-level menus.
---
        ...
        <div class="[ menubar__dropdown ] [ box pad6 radius8 bdr minw180 position-absolute ]" role="menu">
          {#each menu.items as sub, subIdx}
            <button
              ...
              class:menubar__subitem--highlighted={subIdx === activeSubIndex}

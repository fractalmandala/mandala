---
title: Data Table
description: A full-featured reactive Data Table component built with **Svelte 5 Runes** (`$state`, `$derived`, `$props`). Features client-side column sorting, text filtering, pagination, and multi-row selection.
---

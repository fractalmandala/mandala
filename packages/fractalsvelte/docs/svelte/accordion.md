---
title: Accordion
description: A controlled, accessible Accordion component powered by **Svelte 5 Context** and **Runes** (`$state`, `$bindable`, `$props`). Supports single or multiple open items with smooth collapse state tracking and keyboard navigation.
---
...
<div class="[ accordion-item ] [ box w100 ]" data-state={isOpen ? 'open' : 'closed'}>
  ...
  >
    <span>{title}</span>
    <svg class="[ accordion-item__chevron ] [ width16 height16 ]" class:rotate180={isOpen} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      <path d="M6 9l6 6 6-6"/>
    </svg>
  </button>

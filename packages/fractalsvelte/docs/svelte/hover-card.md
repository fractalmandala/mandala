---
title: Hover Card
description: A Hover Card component featuring delay timers powered by **Svelte 5 Runes** (`$state`, `$effect`, `$props`). Prevents accidental popup triggers using controlled `mouseenter` / `mouseleave` timer effects.
---

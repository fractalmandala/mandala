---
title: Input OTP
description: An accessible single-digit OTP input component powered by **Svelte 5 Runes** (`$state`, `$derived`, `$props`). Features auto-advancing focus on input, backspace traversal, and multi-digit clipboard paste handling.
---

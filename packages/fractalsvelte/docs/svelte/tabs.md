---
title: Tabs
description: A controlled Tabs component powered by **Svelte 5 Runes** (`$state`, `$bindable`, `$props`). Tracks active tab selection with `$bindable(value)` and renders active panel content dynamically.
---

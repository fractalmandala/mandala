---
title: Select
description: A custom styled Select component powered by **Svelte 5 Runes** (`$state`, `$derived`, `$props`). Features full ARIA listbox keyboard traversal and custom option rendering.
---

---
title: Alert Dialog
description: An accessible modal Alert Dialog component built for asynchronous confirmation workflows. Uses **Svelte 5 Runes** (`$state`, `$props`) to control open states, trap keyboard focus, and handle promise resolutions on confirmation or cancellation.
---

---
title: Date Picker
description: A Date Picker component combining input parsing, popover popup toggle, and calendar grid calculation using **Svelte 5 Runes** (`$state`, `$derived`, `$props`).
---

---
title: Calendar
description: A reactive Calendar component powered by **Svelte 5 Runes** (`$state`, `$derived`, `$props`). Computes month date grids dynamically using JavaScript `Date` math and reactive derived states.
---

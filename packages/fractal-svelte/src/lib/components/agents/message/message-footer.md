...
- Static source check: reviewed `message/message-footer.svelte` for child order, contextual alignment hooks, content growth, and fixed-size constraints.

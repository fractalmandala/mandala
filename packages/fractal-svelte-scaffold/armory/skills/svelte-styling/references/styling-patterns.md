...
<div style:--primary={theme.primary} style:--secondary={theme.secondary} style:--font={theme.font}>
	{@render children()}
</div>
...
<button class:active class:disabled={!enabled} onclick={() => (active = !active)}> Toggle </button>

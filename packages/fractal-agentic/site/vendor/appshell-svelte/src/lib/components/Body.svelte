<script lang="ts">
  ...
  import ButtonPlain from './ButtonPlain.svelte';
...
<section class="body">
  ...
  <div class="buttons"><ButtonAccent /><ButtonPlain /></div>
</section>

<style>
  .body { display: flex; flex-direction: column; gap: 16px; width: 100%; }
  p { margin: 0; color: #000; font-size: 15px; letter-spacing: -0.3px; line-height: 24px; }

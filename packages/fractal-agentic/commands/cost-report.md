---
description: Generate a local the coding agent cost report from the ECC cost-tracker metrics log.
argument-hint: [csv]
---

# Cost Report

Summarize local the coding agent spend by day, model, and session from the metrics

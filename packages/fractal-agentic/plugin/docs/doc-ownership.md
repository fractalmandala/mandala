...
| `docs/DEGRADATION.md` | Canonical non-blocking policy |
...
| Non-blocking or pin policy | `docs/DEGRADATION.md` and the orchestration runtime if the procedure changes |

...
Everything optional (capability pins, safety hooks, LLM wiki, self-improvement plane) degrades cleanly — see [DEGRADATION.md](./DEGRADATION.md).
...
non-blocking degradation policies pass:

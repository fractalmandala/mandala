...
**Doctrine:** missing pins, hooks, marketplace, or wiki **never** freeze product work. Degrade and continue — [DEGRADATION.md](./DEGRADATION.md).
...
3. [DEGRADATION.md](./DEGRADATION.md) — pin layers  

...
Analyze your repository's git history to extract coding patterns and generate SKILL.md files that capture your team's practices for any coding agent.
...
3. **Generates SKILL.md** - Creates valid agent skill files (SKILL.md)
...
_Related: [Everything Claude Code (ECC)](https://github.com/affaan-m/everything-claude-code)_

...
Use this command as a conversational map of Everything Claude Code (ECC). It should help the user discover the right ECC surface for their task without dumping the entire README or stale catalog counts.
...
- `AGENTS.md` for startup routing and `docs/bosses/<boss>/INDEX.md` for the selected
  domain's authoritative mappings and phases
...
- `/security-scan` for agent-host/OpenCode configuration security review

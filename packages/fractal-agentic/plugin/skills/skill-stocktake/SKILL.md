...
description: 'Use when auditing agent skills and commands for quality. Supports Quick Scan (changed skills only) and Full Stocktake modes with sequential subagent batch evaluation.'
metadata:
  origin: ECC
---
...
Slash command (`/skill-stocktake`) that audits all agent skills and commands using a quality checklist + AI holistic judgment. Supports two modes: Quick Scan for recently changed skills, and Full Stocktake for a complete review.

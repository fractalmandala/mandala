# Agent config template (Codex-compatible host paths)
...
---
    ...
    Every wiki page and fractal episode MUST include YAML frontmatter with at least:
    title, **description** (one line, ≤120 characters — used in wiki/index.md), tags,
    created, updated. Wiki pages also need sources: when claims come from raw material.

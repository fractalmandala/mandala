---
name: cost-tracking
description: Track and report the coding agent token usage, spending, and budgets from the local ECC cost-tracker metrics log. Use when the user asks about costs, spending, usage, tokens, budgets, or cost breakdowns by model, session, or date.
metadata:
  origin: community
---
...
Use this skill to analyze the coding agent cost and usage history from the metrics log

...
policy lives in [docs/DEGRADATION.md](../../docs/DEGRADATION.md). Do not replace the
...
**warnings and degradation** — never refuse implementation, freeze the session, or
...
[docs/DEGRADATION.md](../../docs/DEGRADATION.md).
...
If that type is not exposed → primary or general implementer (degradation path).

...
description: Complex implementer capability lane for Fractal Agentic orchestration. Use under boss-orchestration skill with five-part contracts. Hosts with optional capability-pin templates should prefer the matching TOML custom-agent pin when available.
...
You are the **Complex implementer** capability lane for Fractal Agentic.

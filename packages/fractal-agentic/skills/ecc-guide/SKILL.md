...
Use this skill when a user needs help understanding, navigating, installing, or choosing parts of Everything Claude Code (ECC).
...
- `AGENTS.md`: startup routing and one-boss selection
- `docs/bosses/<boss>/INDEX.md`: authoritative mappings, phases, verification, and
  handoffs for the selected domain
...
- `/security-scan`: inspect agent-host/OpenCode configuration security

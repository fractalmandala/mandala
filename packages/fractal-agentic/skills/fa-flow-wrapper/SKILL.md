---
name: "fa-flow-mapper"
description: "Maps an app's/project's UI containers, layout flow, states, and architecture into Mermaid and a beautiful draggable HTML canvas. Invoke when the user points to a component, page, layout, or app and requests structural analysis."
---
...
Return a Mermaid diagram that represents both containment and important flow.
...
Create a self-contained HTML artifact named `fa-flow-map.html` unless the user specifies another path.

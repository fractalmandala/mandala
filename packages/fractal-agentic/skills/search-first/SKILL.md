...
Agent(subagent_type="general-purpose", prompt="
  ...
  Search: npm/PyPI, MCP servers, agent skills, GitHub
  Return: Structured comparison with recommendation
")
```

Older the coding agent docs may call this `Task(...)`; use the current agent/subagent
...
- LLM SDK → Context7 for latest docs

...
6. Treat every crop as binding reference. When the host exposes image generation, use the imagegen skill / built-in `image_gen` path by default when generation or editing is needed.

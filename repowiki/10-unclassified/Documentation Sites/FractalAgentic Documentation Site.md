...
- [README.md](file://sites/fractalagentic/README.md)
- [vite.config.ts](file://sites/fractalagentic/vite.config.ts)
- [deno.json](file://sites/fractalagentic/deno.json)
- [src/routes/+layout.svelte](file://sites/fractalagentic/src/routes/+layout.svelte)
- [src/routes/+page.svelte](file://sites/fractalagentic/src/routes/+page.svelte)
- [src/routes/+page.server.ts](file://sites/fractalagentic/src/routes/+page.server.ts)
- [src/lib/site.ts](file://sites/fractalagentic/src/lib/site.ts)
- [src/lib/search/resolver.ts](file://sites/fractalagentic/src/lib/search/resolver.ts)
- [scripts/search/postbuild.mjs](file://sites/fractalagentic/scripts/search/postbuild.mjs)
</cite>
...
**Diagram sources**
- [vite.config.ts:134-156](file://sites/fractalagentic/vite.config.ts#L134-L156)
- [package.json:6-17](file://sites/fractalagentic/package.json#L6-L17)

**Section sources**
- [README.md:1-37](file://sites/fractalagentic/README.md#L1-L37)
- [package.json:1-59](file://sites/fractalagentic/package.json#L1-L59)
...
**Section sources**
- [src/routes/+layout.svelte:1-126](file://sites/fractalagentic/src/routes/+layout.svelte#L1-L126)
- [src/routes/+page.svelte:1-145](file://sites/fractalagentic/src/routes/+page.svelte#L1-L145)
- [src/routes/+page.server.ts:1-22](file://sites/fractalagentic/src/routes/+page.server.ts#L1-L22)
- [src/lib/site.ts:1-26](file://sites/fractalagentic/src/lib/site.ts#L1-L26)
- [src/lib/search/resolver.ts:1-27](file://sites/fractalagentic/src/lib/search/resolver.ts#L1-L27)
...
**Diagram sources**
- [vite.config.ts:108-132](file://sites/fractalagentic/vite.config.ts#L108-L132)
- [vite.config.ts:134-156](file://sites/fractalagentic/vite.config.ts#L134-L156)
- [scripts/search/postbuild.mjs:1-46](file://sites/fractalagentic/scripts/search/postbuild.mjs#L1-L46)
- [src/lib/search/resolver.ts:12-26](file://sites/fractalagentic/src/lib/search/resolver.ts#L12-L26)
...
**Diagram sources**
- [src/routes/+layout.svelte:16-46](file://sites/fractalagentic/src/routes/+layout.svelte#L16-L46)
- [src/routes/+layout.svelte:27-32](file://sites/fractalagentic/src/routes/+layout.svelte#L27-L32)
...
**Diagram sources**
- [src/routes/+page.svelte:14-41](file://sites/fractalagentic/src/routes/+page.svelte#L14-L41)
- [src/routes/+page.svelte:43-84](file://sites/fractalagentic/src/routes/+page.svelte#L43-L84)
...
**Section sources**
- [vite.config.ts:1-157](file://sites/fractalagentic/vite.config.ts#L1-L157)
- [scripts/search/postbuild.mjs:1-46](file://sites/fractalagentic/scripts/search/postbuild.mjs#L1-L46)
...
**Section sources**
- [README.md:26-28](file://sites/fractalagentic/README.md#L26-L28)
...
**Section sources**
- [src/routes/+page.svelte:59-83](file://sites/fractalagentic/src/routes/+page.svelte#L59-L83)
...
**Section sources**
- [vite.config.ts:145-150](file://sites/fractalagentic/vite.config.ts#L145-L150)
- [package.json:6-17](file://sites/fractalagentic/package.json#L6-L17)
- [src/lib/site.ts:10-10](file://sites/fractalagentic/src/lib/site.ts#L10-L10)
...
**Diagram sources**
- [package.json:19-48](file://sites/fractalagentic/package.json#L19-L48)
- [vite.config.ts:108-132](file://sites/fractalagentic/vite.config.ts#L108-L132)
...
**Section sources**
- [vite.config.ts:56-71](file://sites/fractalagentic/vite.config.ts#L56-L71)
- [scripts/search/postbuild.mjs:16-24](file://sites/fractalagentic/scripts/search/postbuild.mjs#L16-L24)
...
**Section sources**
- [README.md:26-36](file://sites/fractalagentic/README.md#L26-L36)
- [deno.json:1-12](file://sites/fractalagentic/deno.json#L1-L12)
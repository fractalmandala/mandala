---
kind: frontend_style
name: Token-Driven SASS + CSS Architecture with Blume Theme Layer
category: frontend_style
scope:
    - '**'
source_files:
    - apps/fracta/src/app.css
    - apps/shradhapp/design-tokens.json
    - sites/fractalhome/theme.css
    - sites/fractalwiki/design-tokens.json
    - packages/fractal-svelte/package.json
    - packages/fractal-svelte/src/site/site.sass
    - sites/fractalhome/blume.config.ts
---

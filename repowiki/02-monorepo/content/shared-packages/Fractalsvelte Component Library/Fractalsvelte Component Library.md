# Fractalsvelte Component Library

<cite>
**Referenced Files in This Document**
- [package.json](file://packages/fractalsvelte/package.json)
- [index.ts](file://packages/fractalsvelte/src/lib/index.ts)
- [button.svelte](file://packages/fractalsvelte/src/lib/components/button/button.svelte)
- [button index.ts](file://packages/fractalsvelte/src/lib/components/button/index.ts)
- [dialog index.ts](file://packages/fractalsvelte/src/lib/components/dialog/index.ts)
- [table index.ts](file://packages/fractalsvelte/src/lib/components/table/index.ts)
- [sidebar index.ts](file://packages/fractalsvelte/src/lib/components/sidebar/index.ts)
- [form index.ts](file://packages/fractalsvelte/src/lib/components/form/index.ts)
- [conversation index.ts](file://packages/fractalsvelte/src/lib/components/ai-elements/conversation/index.ts)
- [styles index.sass](file://packages/fractalsvelte/src/lib/styles/index.sass)
</cite>
...
**Diagram sources**
- [package.json:29-429](file://packages/fractalsvelte/package.json#L29-L429)
- [index.ts:1-2](file://packages/fractalsvelte/src/lib/index.ts#L1-L2)
- [button index.ts:1-12](file://packages/fractalsvelte/src/lib/components/button/index.ts#L1-L12)
- [dialog index.ts:1-60](file://packages/fractalsvelte/src/lib/components/dialog/index.ts#L1-L60)
- [table index.ts:1-29](file://packages/fractalsvelte/src/lib/components/table/index.ts#L1-L29)
- [sidebar index.ts:1-121](file://packages/fractalsvelte/src/lib/components/sidebar/index.ts#L1-L121)
- [form index.ts:1-41](file://packages/fractalsvelte/src/lib/components/form/index.ts#L1-L41)
- [conversation index.ts:1-32](file://packages/fractalsvelte/src/lib/components/ai-elements/conversation/index.ts#L1-L32)
- [styles index.sass](file://packages/fractalsvelte/src/lib/styles/index.sass)

**Section sources**
- [package.json:1-486](file://packages/fractalsvelte/package.json#L1-L486)
- [index.ts:1-2](file://packages/fractalsvelte/src/lib/index.ts#L1-L2)
...
**Diagram sources**
- [button.svelte:1-88](file://packages/fractalsvelte/src/lib/components/button/button.svelte#L1-L88)
- [dialog index.ts:1-60](file://packages/fractalsvelte/src/lib/components/dialog/index.ts#L1-L60)
- [sidebar index.ts:1-121](file://packages/fractalsvelte/src/lib/components/sidebar/index.ts#L1-L121)
- [form index.ts:1-41](file://packages/fractalsvelte/src/lib/components/form/index.ts#L1-L41)
- [conversation index.ts:1-32](file://packages/fractalsvelte/src/lib/components/ai-elements/conversation/index.ts#L1-L32)
...
**Diagram sources**
- [package.json:430-485](file://packages/fractalsvelte/package.json#L430-L485)

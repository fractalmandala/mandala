...
- [package.json](file://packages/svelte-animated-icon/package.json)
- [README.md](file://packages/svelte-animated-icon/README.md)
- [index.ts](file://packages/svelte-animated-icon/src/lib/index.ts)
- [index.svelte.ts](file://packages/svelte-animated-icon/src/lib/core/index.svelte.ts)
- [AnimatedIcon.svelte](file://packages/svelte-animated-icon/src/lib/core/AnimatedIcon.svelte)
- [templates.svelte.ts](file://packages/svelte-animated-icon/src/lib/core/templates.svelte.ts)
- [easings.ts](file://packages/svelte-animated-icon/src/lib/utils/easings.ts)
- [phosphor/index.ts](file://packages/svelte-animated-icon/src/lib/phosphor/index.ts)
- [Gear.svelte](file://packages/svelte-animated-icon/src/lib/phosphor/icons/Gear.svelte)
</cite>

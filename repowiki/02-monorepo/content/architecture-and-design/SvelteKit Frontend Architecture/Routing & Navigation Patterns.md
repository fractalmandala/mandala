...
- [+layout.ts](file://apps/fracta/src/routes/+layout.ts)
- [+layout.svelte](file://apps/shradhapp/src/routes/+layout.svelte)
- [+layout.svelte](file://sites/fractalagentic/src/routes/+layout.svelte)
- [+page.svelte](file://sites/fractalagentic/src/routes/agents/[slug]/+page.svelte)
- [+page.svelte](file://sites/fractalagentic/src/routes/docs/[...slug]/+page.svelte)

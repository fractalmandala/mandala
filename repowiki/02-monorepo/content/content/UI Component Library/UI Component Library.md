...
- [motion/index.ts](file://packages/fractal-svelte/src/lib/components/motion/index.ts)
- [agents/index.ts](file://packages/fractal-svelte/src/lib/components/agents/index.ts)
- [blocks/index.ts](file://packages/fractal-svelte/src/lib/components/blocks/index.ts)
- [button/index.ts](file://packages/fractal-svelte/src/lib/components/motion/button/index.ts)
- [input/index.ts](file://packages/fractal-svelte/src/lib/components/motion/input/index.ts)
- [switch/index.ts](file://packages/fractal-svelte/src/lib/components/motion/switch/index.ts)
- [checkbox/index.ts](file://packages/fractal-svelte/src/lib/components/motion/checkbox/index.ts)
</cite>
...
- [motion/index.ts:1-13](file://packages/fractal-svelte/src/lib/components/motion/index.ts#L1-L13)
- [agents/index.ts:1-10](file://packages/fractal-svelte/src/lib/components/agents/index.ts#L1-L10)
- [blocks/index.ts:1-9](file://packages/fractal-svelte/src/lib/components/blocks/index.ts#L1-L9)
...
**Diagram sources**
- [button/index.ts:1-4](file://packages/fractal-svelte/src/lib/components/motion/button/index.ts#L1-L4)
- [input/index.ts:1-2](file://packages/fractal-svelte/src/lib/components/motion/input/index.ts#L1-L2)
- [switch/index.ts:1-2](file://packages/fractal-svelte/src/lib/components/motion/switch/index.ts#L1-L2)
- [checkbox/index.ts:1-2](file://packages/fractal-svelte/src/lib/components/motion/checkbox/index.ts#L1-L2)
...
**Section sources**
- [package.json:215-218](file://packages/fractal-svelte/package.json#L215-L218)
- [package.json:60-68](file://packages/fractal-svelte/package.json#L60-L68)

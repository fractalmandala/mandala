# Prop and Event Extension

<cite>
**Referenced Files in This Document**
- [button.svelte](file://fractal-svelte/src/lib/components/motion/button/button.svelte)
- [index.ts (Button)](file://fractal-svelte/src/lib/components/motion/button/index.ts)
- [message.svelte](file://fractal-svelte/src/lib/components/agents/message/message.svelte)
- [context.ts (Message)](file://fractal-svelte/src/lib/components/agents/message/context.ts)
- [index.ts (Message)](file://fractal-svelte/src/lib/components/agents/message/index.ts)
</cite>
...
- [message.svelte](file://fractal-svelte/src/lib/components/agents/message/message.svelte)
- [context.ts (Message)](file://fractal-svelte/src/lib/components/agents/message/context.ts)
- [index.ts (Message)](file://fractal-svelte/src/components/agents/message/index.ts)

...
- [session-start.js](file://hooks/scripts/session-start.js)
- [periodic-essay-due.js](file://hooks/scripts/periodic-essay-due.js)
- [lib.js](file://hooks/scripts/lib.js)
- [profiles.json](file://hooks/profiles.json)
- [hooks.claude.json](file://hooks/hooks.claude.json)
- [hooks.cursor.json](file://hooks/hooks.cursor.json)
- [periodic-essay-runner.js](file://scripts/periodic-essay-runner.js)
- [hooks.md](file://docs/hooks.md)
- [README.md](file://hooks/README.md)
- [install-hooks.sh](file://scripts/install-hooks.sh)
- [pre-bash-safety.js](file://hooks/scripts/pre-bash-safety.js)
- [pre-no-verify.js](file://hooks/scripts/pre-no-verify.js)
- [pre-config-protection.js](file://hooks/scripts/pre-config-protection.js)
- [session-handoff-detect.js](file://hooks/scripts/session-handoff-detect.js)
- [stop-session-ledger.js](file://hooks/scripts/stop-session-ledger.js)
</cite>

...
- [hooks/hooks.cursor.json](file://fractal-agentic/hooks/hooks.cursor.json)
- [scripts/install-hooks.sh](file://fractal-agentic/scripts/install-hooks.sh)
- [docs/hooks.md](file://fractal-agentic/docs/hooks.md)
</cite>
...
- [hooks/hooks.cursor.json:1-48](file://fractal-agentic/hooks/hooks.cursor.json#L1-L48)
- [hooks/scripts/lib.js:1-137](file://fractal-agentic/hooks/scripts/lib.js#L1-L137)
- [scripts/install-hooks.sh:1-380](file://fractal-agentic/scripts/install-hooks.sh#L1-L380)
- [docs/hooks.md:1-128](file://fractal-agentic/docs/hooks.md#L1-L128)

...
Fractal Agentic is an agents, skills, commands, workflows and harnessing system for coding agents. It gives a project a stable operating model: choose the domain that owns the work, use a delivery runtime to carry it through implementation and review, and pull local skills, agents, and commands as needed.

The package is host-agnostic at its core. It is tuned for the personal defaults - Svelte 5, SvelteKit, and indented SASS - but the project mandate and delivery process can be used with any stack.

...
<svelte:head>
	<title>{page.status} | fractalagentic</title>
</svelte:head>
...
<section class="error-page">
	...
	<p class="message">
		{page.error?.message ?? "The page you're looking for doesn't exist or was moved."}
	</p>
	<div class="actions">
		<a class="btn primary" href={resolve('/')}>Go home</a>

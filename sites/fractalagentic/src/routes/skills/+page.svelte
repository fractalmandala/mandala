...
<svelte:head><title>Skills | fractalagentic</title></svelte:head>

<section class="catalog-page box gap24 padtop16 padbot64">
	<header class="box gap12">
		<p class="eyebrow">Armory / Skills</p>
		<h1 class="display-md">Skills</h1>
		<p class="lede">
			Reusable capabilities vendored with the plugin — each one equips a session for a specific job.
		</p>
	</header>

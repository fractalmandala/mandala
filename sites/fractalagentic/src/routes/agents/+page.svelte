...
<svelte:head><title>Agents | fractalagentic</title></svelte:head>

<section class="catalog-page box gap24 padtop16 padbot64">
	<header class="box gap12">
		<p class="eyebrow">Armory / Agents</p>
		<h1 class="display-md">Agents</h1>
		<p class="lede">Capability lanes the delivery runtime pins for implementation and review.</p>
	</header>

export const SITE_NAME = 'fractalagentic';
 ...
 */
export const SITE_URL = 'https://fractal-agentic.vercel.app';
 ...
 * empty to hide both.
 */
export const REPO_URL = 'https://github.com/fractalmandala/mandala';

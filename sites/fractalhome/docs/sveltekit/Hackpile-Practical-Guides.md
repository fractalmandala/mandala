---
title: Hackpile Practical Guides
description: Collection of practical, real-world Svelte app building guides covering image optimization, Claude AI setup for Svelte 5, tag organization, and the Hackpile knowledge collection.
knowledge-bank:
  - 10-sveltekit
tags:
  - svelte
  ...
  - ai-setup
sources:
  - The-Hackpile-—-Practical-guides-for
  - Claude-AI-Setup-for-Svelte-5
  - All-Tags-The-Hackpile
  - accessibility-—-Tags
  - workflows - Files - File Browser
  - Knowledge-Map
  - Learn-—-Structured-Courses
  - Breadcrumb - Svelto UI
related:
  - Svelte-5-Runes
...
- Additional tags for component patterns, state management, animations, etc.

## See Also
- [Svelte 5 Runes](Svelte-5-Runes) — core reactivity concepts
- [CALM Systems Philosophy](CALM-Systems-Philosophy) — architectural principles for practical development
- [SvelteKit Advanced Features](SvelteKit-Advanced-Features) — performance, SEO, and image optimization
